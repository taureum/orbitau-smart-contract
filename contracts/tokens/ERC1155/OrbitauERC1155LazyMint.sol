...
import "./OrbitauERC1155.sol";
import "../../lib/utils/cryptography/draft-EIP712.sol";

contract OrbitauERC1155LazyMint is OrbitauERC1155, EIP712 {
    string private constant SIGNING_DOMAIN = "Orbitau1155";
    ...
    /**
     * @dev Create a new OrbitauERC1155 contract and set the `_uri` value.
     *
     */
    constructor(string memory uri_) OrbitauERC1155(uri_) EIP712(SIGNING_DOMAIN, SIGNATURE_VERSION) {
    }
    ...
    internal view returns (bytes32)
    {
        return _hashTypedDataV4(keccak256(abi.encode(
                keccak256("OrbitauERC1155(string uri,uint256 amount,uint256 salt)"),
